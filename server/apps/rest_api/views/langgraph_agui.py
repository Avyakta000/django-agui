...
from apps.rest_api.copilotkit.agents.general import general_graph as graph
...
async def agui_langgraph_handler(request):
    ...
    """
    try:
        agent = LangGraphAgent(name="general-assistant", description="Agent for mcp's", graph=graph)
